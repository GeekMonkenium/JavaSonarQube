 ...
 */
public abstract class HybrisRequest implements IRequest {

    private final HybrisHeaders headers;
     ...
     */
    public HybrisRequest(HybrisHeaders headers, HttpMethods httpMethod, IPathParameters pathParameters, IQueryParams queryParameters, IRequestBody requestBody) {
     ...
     */
    @Override
    public HybrisHeaders getHeaders() {
        return headers;
    }
